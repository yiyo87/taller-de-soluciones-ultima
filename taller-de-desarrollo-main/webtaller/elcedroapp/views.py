...
def crear_pedido(request):
    if request.method == 'POST':
        ...
        # Enviar SMS al número de teléfono registrado
        mensaje = f"Nuevo pedido registrado a nombre de {nombre}. Dirección: {direccion}. Cantidad de bidones: {cantidad}."
        enviar_sms(mensaje, numero)  # Llama a la función para enviar el SMS
